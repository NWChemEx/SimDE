...
namespace property_types {
    ...
    struct CauchySchwarzApprox : public sde::PropertyType<CauchySchwarzApprox<ElementType>> {
...
//------------------------Implementations---------------------------------------
    ...
    auto CauchySchwarzApprox<ElementType>::results_() {
        ...
        rv["Screening Matrix"].set_description("The Cauchy Schwarz screening matrix");
        return rv;
    }
