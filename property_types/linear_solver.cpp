...
template class LinearSolver<std::complex<double>,std::complex<double>,std::complex<double>>;
...
template class LinearSolver<std::complex<float>,std::complex<float>,std::complex<float>>;
