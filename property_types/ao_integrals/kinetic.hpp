...
/**
 * @brief The property type for modules that build tensors filled with electron kinetic
 * energy integrals in the AO basis set.
 *
 * @tparam ElementType The type of the element in the tensor. Defaults to
 *                     `double`.
 */
    template<typename ElementType = double>
    struct KineticIntegral : public sde::PropertyType<KineticIntegral<ElementType>> {
