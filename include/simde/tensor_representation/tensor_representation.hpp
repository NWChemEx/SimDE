...
using TotalCanonicalEnergy_Nuclear = TotalEnergy_Nuclear<type::canonical_reference>;
...
using CanonicalElectronicEnergy_Nuclear = ElectronicEnergy_Nuclear<type::canonical_reference>;
