...
if [ "${USE_CLANG}" = true ]; then
   docker build -t ghcr.io/nwchemex-project/release_simde:clang-latest -f release.Dockerfile .
   docker push ghcr.io/nwchemex-project/release_simde:clang-latest
else
   docker build -t ghcr.io/nwchemex-project/release_simde:gcc-latest -f release.Dockerfile .
   docker push ghcr.io/nwchemex-project/release_simde:gcc-latest
fi
